...
public class PollingProgram {
	public static void main(String[] args) {
      ...
      //rows for topics and column for ratings
      ...
      while (notFinished)
      {
    	  ...
    	  for (int i = 0; i < 5; ++i)
    	  {
    		  ...
    		  System.out.print(totalResponses * 1.00 / totalResponders + "   ");
    		  System.out.println();
    		  totalResponses = 0;
    	  }
    	  ...
    	  System.out.println("Topic with lowest total points is " + topics[tempLowest] 
    			  + ". It recieved " + lowest + " points.");
    	  //console read?? C++ 
      }
